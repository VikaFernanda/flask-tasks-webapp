pipeline {
    ...
    environment {
        registryCredential = 'AKIAZQ3DQ6BV4K3OZ5WG' /* Replace by the proper values */
    ...
    stages {
        stage('Fetch code') {
            steps {
                git branch: 'main', url: 'https://github.com/VikaFernanda/flask-tasks-webapp.git' /* Replace by the proper values */
            }
        }
